        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <span
              ...
              style={{ fontFamily: "lulo-clean-w01-one-bold, sans-serif" , fontSize:"24px", letterSpacing: "0.1em"}}
            >
              UNI
            </span>
            <span
              style={{ color: `#F2C21A`, fontFamily: "lulo-clean-w01-one-bold, sans-serif" , fontSize:"24px", letterSpacing: "0.1em"}}
              className="text-2xl sm:text-3xl font-semibold"
            >
              NXT
            </span>
